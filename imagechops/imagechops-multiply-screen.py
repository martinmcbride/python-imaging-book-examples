...
# Apply multiply and screen functions to two images
...
composite_image = ImageChops.multiply(image, gradient_image)
...
output_image.save('imagechops-multiply.jpg')

composite_image = ImageChops.screen(image, gradient_image)
composite_image.save('imagechops-screen.jpg')
